...
[`supabase/migrations/0001_tariff_gift_app.sql`](supabase/migrations/0001_tariff_gift_app.sql)
and **Run**. It is idempotent — safe to run more than once.
...
5. Open the bot and send `/start` — the first sender becomes the approver.
